...
export async function GET(request: NextRequest) {
  try {
    ...
    const exampleRows = [
      {
        ...
        'Status (scheduled/confirmed/cancelled)': 'scheduled',
      ...
      },
      {
        ...
        'Status (scheduled/confirmed/cancelled)': 'confirmed',
    ...
    const instructions = [
      ...
      { 'Step': '6', 'Instruction': 'Status: scheduled, confirmed, or cancelled (default is scheduled)' },
