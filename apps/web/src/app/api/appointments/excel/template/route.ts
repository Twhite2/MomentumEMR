...
export async function GET(request: NextRequest) {
  try {
    ...
    const exampleRows = [
      {
        ...
        'Duration (minutes)': '30',
        'Type* (OPD/IPD/surgery/lab/follow_up)': 'OPD',
      ...
      },
      {
        ...
        'Duration (minutes)': '45',
        'Type* (OPD/IPD/surgery/lab/follow_up)': 'follow_up',
    ...
    const instructions = [
      ...
      { 'Step': '5', 'Instruction': 'Type: OPD (Outpatient), IPD (Inpatient), surgery, lab, or follow_up' },
