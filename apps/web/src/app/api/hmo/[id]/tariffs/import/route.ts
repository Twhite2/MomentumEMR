        ...
        try {
          ...
          const tariff = await (prisma as any).hmoTariff.upsert({
            ...
            create: {
              ...
              category: 'Medication',
              unit,
              basePrice: parsePrice(row['Tier 0']) || 0,
              tier0Price: parsePrice(row['Tier 0']),
              tier1Price: parsePrice(row['Tier 1']),
              tier2Price: parsePrice(row['Tier 2']),
              tier3Price: parsePrice(row['Tier 3']),
              tier4Price: parsePrice(row['Tier 4']),
            },
            update: {
              name,
              unit,
